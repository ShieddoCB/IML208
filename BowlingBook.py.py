...
class HotelReservationApp:
    def __init__(self):
        ...
        self.root.title("Syed Bowling Valley | Bowling Booking, System")
...
#Creating the image background
    ...
    def create_main_window(self):
        ...
        self.img = ImageTk.PhotoImage(Image.open("SYED_bowling.jpeg"))
        self.label = Label(self.frame, image=self.img)
        self.label.pack()
        
# Labelling and packing

        i1 = Label(self.root, text="Syed Bowling Valley", bg="#83838B", fg="black", font=('Dotum', 25))
        i2 = Label(self.root, text="Bowling Booking System", fg="black", bg="#83838B", font=('Dotum', 12))
        i1.pack(fill="x")
        i2.pack(fill="x")
...
#Creating frames button for bottom
        ...
        i5 = Label(bf, text="© 2024 Syed Bowling Centre, Sports & Entertainment", bg="white")
        i5.pack(side="left")
        ...
        i9.pack(side="left")
        i12 = Label(bf2, text="Contact Number: +60 11 2705 2159", bg="white")
        i12.pack(side="left")
        i12 = Label(bf3, text="Email us: 2023851512@student.uitm.edu.my", bg="white")
        i12.pack(side="left")
...
# Creating Signup page
    ...
    def sign_up(self):
        ...
        i45 = Label(c, text="Syed Bowling Valley", bg="#83838B", fg="white", font=('Dotum', 25))
        i46 = Label(c, text="Lane Booking", fg="white", bg="#83838B", font=('Dotum', 12))
        i45.pack(fill="x")
        i46.pack(fill="x")
...
#creating a login page
    def login(self):
        ...
        i47 = Label(b, text="Syed Bowling Valley", bg="#83838B", fg="white", font=('Dotum', 25))
        i48 = Label(b, text="Lane Booking", fg="white", bg="#83838B", font=('Dotum', 12))
        i47.pack(fill="x")
        i48.pack(fill="x")
...
# Labelling and packing Room 1
        i10 = Label(d, text="Bowling Lane Booking", bg="#83838B", fg="white", font=('Dotum', 25))
        i11 = Label(d, text="Choose Your Lane", fg="white", bg="#83838B", font=('Dotum', 12))
        i10.pack(fill="x")
        i11.pack(fill="x")

        i30 = Label(d, text="LANE 1", font=('Dotum', 22, 'bold'))
        i30.place(x=430, y=120)

        image = Image.open("lanef.jpg")
        test = ImageTk.PhotoImage(image)
        labell = Label(d, image=test)
        labell.image = test
        labell.place(x=70, y=120)

        i31 = Label(d, text="*Free drinks per games", font=('Dotum', 10, 'bold'), bg="#F0F0FF")
        ...
        i34=Label(d,text="*Must wear shoes to play",font=('Dotum',10),bg="#F0F0FF")
        i34.place(x=430,y=290)

        i35=Label(d,text="- FREE WIFI",font=('Dotum',10),bg="#F0F0FF")
        i35.place(x=70,y=380)

        i36=Label(d,text="- GROUP DISCOUNT AVAILABLE",font=('Dotum',10),bg="#F0F0FF")
        i36.place(x=70,y=410)

        i37=Label(d,text="- MAXIMUM 4 PLAYERS",font=('Dotum',10),bg="#F0F0FF")
        i37.place(x=70,y=440)



        i38 = Label(d, text="- RM30 PER HOUR", font=('Dotum', 10), bg="#F0F0FF")
        i38.place(x=70, y=470)

        image = Image.open("rmb.png")
        test = ImageTk.PhotoImage(image)
        labell = Label(d, image=test)
        labell.image = test
...
# Labelling and packing "Room 2"
        ...
        i30=Label(d,text="LANE 2",font=('Dotum',22,'bold'))
        i30.place(x=1180,y=120)
    
        image = Image.open("lanes.jpg")
        test=ImageTk.PhotoImage(image)
        labell=Label(d,image=test)
        labell.image=test
        labell.place(x=820,y=120)

        i31=Label(d,text="*Free drinks per game",font=('Dotum',10,'bold'),bg="#F0F0FF")
        ...
        def hotel_log_A():
            f = Toplevel()
            f.geometry("1600x800")
            f.title("Bowling Booking System")
...
# Label Widget
            ...
            a.place(relx=0.52, rely=0.1, relheight=0.85, relwidth=0.45)
# Labelling and packing Room 1
            i101 = Label(f, text="Bowling Lane Booking", bg="#83838B", fg="white", font=('Dotum', 25))
            i111 = Label(f, text="Choose Your Lane", fg="white", bg="#83838B", font=('Dotum', 12))
            i101.pack(fill="x")
            i111.pack(fill="x")

            i301 = Label(f, text="LANE 3", font=('Dotum', 22, 'bold'))
            i301.place(x=430, y=120)

            image = Image.open("lanet.jpg")
            test = ImageTk.PhotoImage(image)
            labell1 = Label(f, image=test)
            labell1.image = test
            labell1.place(x=70, y=120)

            i311 = Label(f, text="*Free drinks per games", font=('Dotum', 10, 'bold'), bg="#F0F0FF")
            ...
            i341=Label(f,text="*Must wear shoes to play",font=('Dotum',10),bg="#F0F0FF")
            i341.place(x=430,y=290)

            i351=Label(f,text="- FREE WIFI",font=('Dotum',10),bg="#F0F0FF")
            i351.place(x=70,y=380)

            i361=Label(f,text="- Group Discount Available",font=('Dotum',10),bg="#F0F0FF")
            i361.place(x=70,y=410)

            i371=Label(f,text="- MAXIMUM 4 PLAYERS",font=('Dotum',10),bg="#F0F0FF")
            i371.place(x=70,y=440)



            i381 = Label(f, text="- RM30 Per Hour", font=('Dotum', 10), bg="#F0F0FF")
...
# Labelling and packing "Room 2"
            ...
            i301=Label(f,text="Lane 4",font=('Dotum',22,'bold'))
            i301.place(x=1180,y=120)
    
            image = Image.open("laneo.jpg")
            test=ImageTk.PhotoImage(image)
            labell1=Label(f,image=test)
            labell1.image=test
            labell1.place(x=820,y=120)

            i311=Label(f,text="*Free Drinks Per Game",font=('Dotum',10,'bold'),bg="#F0F0FF")
...
# Book now button for Room 2
        ...
        def book():
            ...
            # Labelling and packing
            i51 = Label(e, text="Lane Booking Confirmation", bg="#83838B", fg="white", font=('Dotum', 25))
            i52 = Label(e, text="Fill the information", fg="white", bg="#83838B", font=('Dotum', 12))
            i51.pack(fill="x")
            i52.pack(fill="x")
            ...
            L51 = Label(e, text="Rate Hour(S)").place(x=620, y=200)
            L52 = Label(e, text="ADULTS:").place(x=620, y=250)
            L53 = Label(e, text="Meals Set:").place(x=620, y=300)
